...
class BaseTrainer:
    ...
    def train(self):
        ...
        # swa_start = 40  # Start SWA after 10 epochs
        ...
        # torch.save(self.swa_model.state_dict(), str(self.checkpoint_dir / 'swa_model.pth'))
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        filename = str(self.checkpoint_dir / 'checkpoint-epoch{}.pth'.format('_last'))
